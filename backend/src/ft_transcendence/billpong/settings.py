"""
Django settings for billpong project.
...
SECRET_KEY = 'django-insecure-9az0mj7ne4t(n4by9l4-!2cv-dimmzlbr%32-2@@(#ljb3sfj^'
...
# Add these settings after your existing CORS configuration
CORS_ALLOW_HEADERS = [
    'accept',
    'accept-encoding',
    'authorization',
...
WSGI_APPLICATION = 'billpong.wsgi.application'
